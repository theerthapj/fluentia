...
test("full Fluentia journey", async ({ page }) => {
  ...
  await page.locator("#landing-start-practicing-button").click();
  ...
  await page.locator("#scenario-formal-advanced-professional-meeting").click();
  ...
  await expect(page.locator("#inline-coaching-tip").getByText(/Tip:/)).toBeVisible({ timeout: 8000 });
