...
const idiomBank: IdiomQuestion[] = [
  ...
  { type: "fix-idiom", id: "id7", scrambled: ["when", "fun", "having", "flies", "you", "are", "time"], correct: ["time", "flies", "when", "you", "are", "having", "fun"], explanation: '"Time flies when you are having fun" means that enjoyable experiences seem to pass very quickly.' },
  // Medium
