...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-bg-primary">
      ...
      <div ref={mobileNavRef} className={cn("fixed bottom-3 left-1/2 z-50 w-full max-w-sm -translate-x-1/2 px-3 transition-opacity duration-500 lg:hidden", introActive && "pointer-events-none opacity-35")}>
        <Sidebar mobileOnly />
      </div>
