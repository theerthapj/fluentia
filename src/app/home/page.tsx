          ...
          <motion.div variants={{ hidden: { opacity: 0, y: 16 }, show: { opacity: 1, y: 0 } }}>
            <GlassCard className="p-7 sm:p-10">
              ...
              <p className="mt-4 max-w-2xl text-lg leading-8 text-text-secondary">
                Practice real conversations with a supportive AI coach that helps you improve fluency, tone, confidence, and vocabulary with formal, casual, pronunciation, and free-chat tracks.
              </p>
